...
///<summary
Shader "Sid/LayeredNoise_Octaves"
{
	Properties
	{
...
#define OCTAVES 4
		...
		{
			//1d, 2 Octave layered noise
			//The amount of times we sample the noise is also called octaves, so this is noise with 2 octaves
		/*	float value = IN.worldPos.x / _CellSize;
			float noise = sampleLayeredNoise2O(value);
